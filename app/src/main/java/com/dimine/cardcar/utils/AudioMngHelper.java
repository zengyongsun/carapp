...
public class AudioMngHelper {
    ...
    public final static int TYPE_CALL = AudioManager.STREAM_VOICE_CALL;

    @IntDef({TYPE_MUSIC, TYPE_ALARM, TYPE_RING, TYPE_CALL})
    ...
    //AudioManager.FLAG_PLAY_SOUND | AudioManager.FLAG_SHOW_UI 媒体设置弹出提示
    public AudioMngHelper addVoiceSystem() {
        audioManager.adjustStreamVolume(NOW_AUDIO_TYPE, AudioManager.ADJUST_RAISE,
